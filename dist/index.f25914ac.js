...
(function(global, factory) {
    ...
    //! moment.js locale configuration
    var months$3 = 'leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec'.split('_'), monthsShort = 'led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro'.split('_'), monthsParse$1 = [
        /^led/i,
        /^úno/i,
        /^bře/i,
        /^dub/i,
    ...
    function translate$1(number, withoutSuffix, key, isFuture) {
        ...
        switch(key){
            ...
            case 'dd':
                if (withoutSuffix || isFuture) return result + (plural$1(number) ? 'dny' : 'dní');
                else return result + 'dny';
            case 'M':
                return withoutSuffix || isFuture ? 'měsíc' : 'měsícem';
            case 'MM':
                if (withoutSuffix || isFuture) return result + (plural$1(number) ? 'měsíce' : 'měsíců');
    ...
    function translate$5(number, withoutSuffix, key, isFuture) {
        ...
        switch(key){
            ...
            case 'ss':
                if (plural$2(number)) return result + (withoutSuffix || isFuture ? 'sekúndur' : 'sekúndum');
                return result + 'sekúnda';
            case 'm':
                return withoutSuffix ? 'mínúta' : 'mínútu';
            case 'mm':
                if (plural$2(number)) return result + (withoutSuffix || isFuture ? 'mínútur' : 'mínútum');
            ...
            case 'yy':
                if (plural$2(number)) return result + (withoutSuffix || isFuture ? 'ár' : 'árum');
    ...
    //! moment.js locale configuration
    var months$9 = 'január_február_marec_apríl_máj_jún_júl_august_september_október_november_december'.split('_'), monthsShort$7 = 'jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec'.split('_');
    function plural$5(n) {
        return n > 1 && n < 5;
    }
    function translate$9(number, withoutSuffix, key, isFuture) {
        ...
        switch(key){
            ...
            case 'ss':
                if (withoutSuffix || isFuture) return result + (plural$5(number) ? 'sekundy' : 'sekúnd');
                else return result + 'sekundami';
            case 'm':
                return withoutSuffix ? 'minúta' : isFuture ? 'minútu' : 'minútou';
            case 'mm':
                if (withoutSuffix || isFuture) return result + (plural$5(number) ? 'minúty' : 'minút');
                else return result + 'minútami';
            case 'h':
                return withoutSuffix ? 'hodina' : isFuture ? 'hodinu' : 'hodinou';
            case 'hh':
                if (withoutSuffix || isFuture) return result + (plural$5(number) ? 'hodiny' : 'hodín');
                else return result + 'hodinami';
            case 'd':
                return withoutSuffix || isFuture ? 'deň' : 'dňom';
            case 'dd':
                if (withoutSuffix || isFuture) return result + (plural$5(number) ? 'dni' : 'dní');
    ...
    function weekdaysCaseReplace(m, format1) {
        ...
        nounCase = /(\[[ВвУу]\]) ?dddd/.test(format1) ? 'accusative' : /\[?(?:минулої|наступної)? ?\] ?dddd/.test(format1) ? 'genitive' : 'nominative';
